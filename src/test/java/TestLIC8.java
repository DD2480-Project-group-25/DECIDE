...
public class TestLIC8 {
    ...
    public void TestIllegalA() {
        ...
        TestUtils.checkErrorMessage(
                () -> Decide.LIC8(pts, params),
                "A_PTS must be greater or equal to 1"
        );
    }
  ...
  @Test(expected = IllegalArgumentException.class)
    public void TestIllegalB() {
        ...
        TestUtils.checkErrorMessage(
                () -> Decide.LIC8(pts, params),
                "B_PTS must be greater or equal to 1"
        );
    }
    ...
    public void TestFewerPointsThanRequired() {
        ...
        TestUtils.checkErrorMessage(
                () -> Decide.LIC8(pts, params),
                "A_PTS + B_PTS not less or equal to NUMPOINTS -3"
        );
    }
    ...
    public void TestPositive() {
        Parameters params = new Parameters(
                0,
                0,
                2, //Only interesting parameters for LIC8
                0,
                0,
                0,
                0,
    ...
    public void TestNegative() {
        Parameters params = new Parameters(
                0,
                0,
                4, //Only interesting parameters for LIC8
                0,
                0,
                0,
                0,
